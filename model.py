...
from ops import (
    lrelu, linear, conv2d, deconv2d, conv_cond_concat, concat, batch_norm,
    image_summary, scalar_summary, histogram_summary, merge_summary,
    SummaryWriter)
from utils import imread, get_image, save_images, image_manifold_size
    ...
    def discriminator(self, image, y=None, reuse=False):
        with tf.variable_scope("discriminator") as scope:
            ...
            if self.y_dim is None:
                ...
                h4 = linear(
                    tf.reshape(h3, [self.batch_size, -1]), 1, 'd_h4_lin')
